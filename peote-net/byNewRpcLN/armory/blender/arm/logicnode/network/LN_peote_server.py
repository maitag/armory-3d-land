...
class PeoteServerNode(ArmLogicTreeNode):
    ...
    property0: HaxeStringProperty('property0', name='RPC Class', description='Name of haxe-class what defines remote server functions', set=set_rpc_class, get=get_rpc_class)
